...
export default function ModalCadastrarPeriodoAvaliacao({ isOpen, setIsOpen }: CadastrarDimensaoProps) {
    ...
    const onSubmit: SubmitHandler<dimensaoType> = async (data) => {
        ...
        try {
            ...
            const submitAPI = await api.post("/periodoAvaliacao", {
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-2xl h-auto transform overflow-hidden rounded-2xl
                                 bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    >
                                        <VscSettings />  <span>Cadastrar Periodo de avaliação</span>
                                    </Dialog.Title>
                                    <div className="mt-2">
                                        ...
                                        <form
                                            ...
                                            <div className='flex flex-col lg:flex-row gap-4 w-full '>
                                                <div className='flex flex-col w-full gap-2'>
                                                    <label
                                                        className='text-lg'
                                                        htmlFor="nomeProf">Periodo *: </label>
                                                    <input
                                                        id='periodo'
