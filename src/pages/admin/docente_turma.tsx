...
import ModalAssociarTurma from '../../components/Admin/ModalAssociarTurmaDocente';
...
const DocenteTurma: NextPage = () => {
    ...
    const { isLoading, error, data } = useQuery('fetchDocentesTurmas', getAllDocents)
                    ...
                    <div className="container lg:px-5 py-16 mx-auto">
                        <div className="flex flex-col items-center justify-center gap-4 lg:max-w-fit mb-6 relative mx-auto">
                            ...
                            <label
                                ...
                                <span className="font-bold text-center text-xl">Associe uma turma a um docente</span>
                            </label>
                            {
                                load ? (<>
