...
const Departamento: NextPage = () => {
    ...
    const handleSubmitDelete: SubmitHandler<generalType> = async (dados) => {
        ...
        try {
            ...
            const response = await api.delete('departamento/', { data: dados.id })
        ...
        <>
            ...
            <main className='px-8 flex gap-8 -mt-10'>
                <SweetAlert2
                    ...
                    title='Sucesso'
                    text='Novo departamento adicionado com sucesso!'
                ...
                />
                <Head>
                    <title>Departamento | Sistema de avaliação de desempenho de docentes</title>
                </Head>
                ...
                <div className='flex-1'>
                    <div className="container lg:px-5 py-16 mx-auto">
                        <div className="flex flex-col items-center justify-center gap-4 lg:max-w-fit mb-6 relative mx-auto">
                            ...
                            <h2 className="font-bold text-center text-xl">Departamentos do INSTIC</h2>
                        ...
                        <form
                            ...
                            <label
                                ...
                                htmlFor="departamento "><FaPlus /> <span>Criar novo Departamento</span></label>
                            <input
                                id='departamento'
                            ...
                            <button
                                disabled={load}
                                type='submit'
                                className='bg-azul text-white px-4 py-2 rounded font-bold hover:brightness-75 disabled:cursor-not-allowed'>Salvar</button>
                                                ...
                                                !searchDepartamento?.length ?
                                                    ...
                                                    data?.map((departamento, index) => (
                                                        <tr
                                                            ...
                                                            <td className="p-2">
                                                                <input type="checkbox" className="w-5 h-5" value={departamento.id}
                                                                />
                                                            </td>
                                                    ...
                                                    : (
                                                        filteredDepartamento?.map((departamento, index) => (
                                                            <tr
                                                                key={index}
                                                                className=''>
                                                                <td className="p-2">
