...
const DimensaoInvestigacao: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Dimensão Investigação | Sistema de avaliação de docentes</title>
            </Head>
                ...
                <div className='flex-1'>
                    <div className="container px-5 py-16 mx-auto">
                        <div className="flex items-center justify-center gap-4 max-w-fit mb-6 relative mx-auto">
                            ...
                            <h2 className="font-bold text-center text-xl">Dimensão Investigação - Respostas</h2>
...
export default DimensaoInvestigacao;